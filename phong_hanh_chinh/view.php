                    ...
                    <div class="block-fluid table-sorting">
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT *  FROM nhan_su where  bo_phan = 'phòng hành chính' and chuc_vu = 'trưởng phòng' or chuc_vu = 'phó phòng'";
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                            ...
                            <tbody>
                                <?php
                                // include "./datebase/db.php";
                                $sql = "SELECT *  FROM nhan_su where chuc_vu = 'nhân viên' and bo_phan = 'phòng hành chính'";
                                $result = $conn->query($sql);
